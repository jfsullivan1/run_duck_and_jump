...
public class Ellipse extends GraphicObject 
{
	...
	{
		super(x, y, angle, width, height, color, 0);
	 ...
	 * @param color		The color is stored as a single int in hex format
	 */
	public Ellipse(float x, float y, float angle, float width, float height, int color, PImage image, int lazer, int time)
	{
		super(x, y, angle, width, height, color, time);
